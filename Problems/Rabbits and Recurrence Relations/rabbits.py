...
"""
x = int(input("give month: "))
y = int(input("litter size: "))

#recursion
def calc_rabitts(n_months, k_litter):
    if n_months == 1:
        return 1
    elif n_months == 2:
        return k_litter
    
    n_minus1 = calc_rabitts(n_months - 1, k_litter)

    n_minus2 = calc_rabitts(n_months - 2, k_litter)

    if n_months <= 4:
        return n_minus1 + n_minus2
    
    return n_minus1 + n_minus2*k_litter

print(calc_rabitts(x, y))